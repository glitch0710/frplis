# Generated by Django 3.2.13 on 2022-09-26 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muncity', models.CharField(max_length=200)),
                ('brgy', models.CharField(max_length=200)),
                ('farmer_id', models.ForeignKey(db_column='farmer_id', on_delete=django.db.models.deletion.CASCADE, to='home.farmer')),
            ],
        ),
        migrations.CreateModel(
